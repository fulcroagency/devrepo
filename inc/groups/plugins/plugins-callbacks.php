...
function cf7_syntax_highlighting_callback() {
    ...
    // get options
    $options = devops_plugins_options();
    $cf7_syntax_highlighting = $options['cf7_syntax_highlighting']['enabled'] ?? '';
    ...
    // Enable function
    echo '<label>';
    echo '<input type="checkbox" id="cf7-syntax-highlighting" name="dev_options_plugins[cf7_syntax_highlighting][enabled]" value="1" ' . checked(1, $cf7_syntax_highlighting, false) . ' data-toggle="cf7-syntax-highlighting-option"> Enable';
    echo '</label>';

    // Additional options
    echo '<div id="cf7-syntax-highlighting-option" class="additional-options">';
